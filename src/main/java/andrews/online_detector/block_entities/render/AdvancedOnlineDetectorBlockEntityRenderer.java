...
public class AdvancedOnlineDetectorBlockEntityRenderer implements BlockEntityRenderer<AdvancedOnlineDetectorBlockEntity>
{
	...
	public void render(AdvancedOnlineDetectorBlockEntity blockEntity, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay)
	{
		...
		if(blockEntity.hasLevel())
		{
			...
			{
				facing = blockstate.getValue(AdvancedOnlineDetectorBlock.HORIZONTAL_FACING);
			}
		}
	...
	private static void renderPlayerFace(AdvancedOnlineDetectorBlockEntity blockEntity, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay)
	{
		if(blockEntity.getOwnerUUID() != null && blockEntity.getOwnerName() != null)
		{
			if(blockEntity.getOwnerHead().getItem() == Items.AIR)
				NetworkUtil.setPlayerHeadMessage(blockEntity.getBlockPos(), getCustomHead(blockEntity.getOwnerName()));
		}
