...
public class AdvancedOnlineDetectorTileEntityRenderer extends TileEntityRenderer<AdvancedOnlineDetectorTileEntity>
{
	...
	public AdvancedOnlineDetectorTileEntityRenderer(TileEntityRendererDispatcher rendererDispatcherIn)
	{
	...
	@Override
	public void render(AdvancedOnlineDetectorTileEntity tileEntityIn, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int combinedLightIn, int combinedOverlayIn)
	{
		Direction facing = Direction.NORTH;
	    if(tileEntityIn.hasWorld())
	    {
	         BlockState blockstate = tileEntityIn.getWorld().getBlockState(tileEntityIn.getPos());
	         if(blockstate.getBlock() instanceof AdvancedOnlineDetectorBlock)
	         {
	        	 facing = blockstate.get(AdvancedOnlineDetectorBlock.HORIZONTAL_FACING);
	         }
	    }
	...
	private static void renderEye(World world, BlockState stateIn, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int combinedLightIn, int combinedOverlayIn)
	{
		...
		if(stateIn.get(AdvancedOnlineDetectorBlock.IS_ACTIVE))
		{
	 ...
	 */
	private static void renderPlayerFace(AdvancedOnlineDetectorTileEntity tileEntityIn, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int combinedLightIn, int combinedOverlayIn)
	{
